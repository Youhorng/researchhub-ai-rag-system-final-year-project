  ...
  return (
    <header
      className={`fixed top-0 left-0 right-0 z-50 transition-all duration-300 ${
        scrolled
          ? 'bg-surface/80 backdrop-blur-md border-b border-[#161f33]'
          : 'bg-transparent'
      }`}
    >
      <div className="max-w-6xl mx-auto px-6 py-4 flex items-center justify-between">
        ...
        <nav className="hidden md:flex items-center gap-3">
          <a
            href="#features"
            className="text-zinc-400 hover:text-on_surface text-sm transition-colors px-3 py-1.5"
          >
            Features
          </a>
          <a
          ...
          <a
            href="/sign-in"
            className="text-zinc-300 hover:text-white text-sm transition-colors px-4 py-2"
          >
            Sign In
          </a>
          <a
            href="/sign-up"
            className="px-4 py-2 bg-primary-gradient text-white rounded-xl text-sm font-medium shadow-[0_0_16px_rgba(167,165,255,0.2)] hover:shadow-[0_0_24px_rgba(167,165,255,0.4)] transition-all"
          >
            Get Started
          </a>
        </nav>
    ...
    <section className="relative min-h-screen flex flex-col items-center justify-center px-6 pt-24 pb-16 overflow-hidden">
      ...
      <div className="relative z-10 flex flex-col items-center text-center max-w-4xl mx-auto">
        ...
        <div className="flex flex-col sm:flex-row gap-4 items-center">
          <a
            href="/sign-up"
            className="flex items-center gap-2 px-7 py-3.5 bg-primary-gradient text-white rounded-xl font-semibold shadow-[0_0_24px_rgba(167,165,255,0.3)] hover:shadow-[0_0_36px_rgba(167,165,255,0.5)] transition-all text-base"
          >
            Get Started Free
            <ArrowRight size={18} />
          </a>
          <a
            href="#how-it-works"
            className="flex items-center gap-2 px-7 py-3.5 bg-surface_container_high text-white hover:bg-surface_bright border border-[#212c43] rounded-xl font-medium transition-all text-base"
          >
            See How It Works
        ...
        {/* Hero visual mock */}
        <div className="mt-16 w-full max-w-3xl rounded-2xl border border-[#1b263b] bg-surface_container overflow-hidden shadow-[0_0_60px_rgba(167,165,255,0.08)] relative">
          {/* Window chrome */}
          ...
          <div className="p-6 flex flex-col gap-4 text-left min-h-[260px]">
            ...
            <div className="flex items-start gap-3">
              ...
              <div className="max-w-[80%] px-4 py-2.5 rounded-2xl rounded-tl-sm bg-surface_container_high border border-[#1b263b] text-zinc-300 text-sm leading-relaxed">
                The attention mechanism introduced in "Attention Is All You Need" enables models to dynamically weight the relevance of each token relative to others in the sequence —
                removing the need for recurrence entirely.{' '}
...
const FEATURES = [
  {
    icon: Search,
    title: 'AI Paper Discovery',
    description:
      'Search 700k+ arXiv papers with hybrid BM25 + vector search. Find exactly what you need — fast.',
  },
  {
    icon: BookOpen,
    title: 'Project Knowledge Bases',
    description:
      'Accept papers and upload your own PDFs to per-project knowledge bases. Keep everything organised.',
  },
  {
    icon: MessageSquare,
    title: 'RAG-Powered Chat',
    description:
      'Ask questions in natural language and get answers grounded in your papers — with source citations.',
  },
  {
    icon: FileText,
    title: 'Smart Summaries',
    description:
      "Auto-generated paper summaries and keyword extractions so you can quickly decide what's worth reading.",
  },
  {
    icon: Tag,
    title: 'Research Topics',
    description:
      'Organise your knowledge base with custom topics and filter papers by category or keyword.',
  },
  {
    icon: BarChart2,
    title: 'Activity & Analytics',
    description:
      'Track your reading sessions, paper activity, and research progress over time with built-in dashboards.',
  },
]
      ...
      <div className="max-w-6xl mx-auto">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-5">
          {FEATURES.map(({ icon: Icon, title, description }) => (
            <div
              key={title}
              className="group p-6 rounded-2xl bg-surface_container border border-[#161f33] hover:border-[#212c43] hover:bg-surface_container_high transition-all duration-300 hover:shadow-[0_0_24px_rgba(167,165,255,0.06)]"
            >
...
const STEPS = [
  {
    ...
    description:
      'Search over 700k+ arXiv papers using AI-powered hybrid search. Filter by topic, date, or relevance.',
  },
  {
    number: '02',
    icon: BookOpen,
    ...
    description:
      'Accept papers into your project and upload your own PDFs. ResearchHub chunks and indexes everything for you.',
  },
  {
    number: '03',
    icon: MessageSquare,
    ...
    description:
      'Ask questions in plain language. Get answers grounded in your knowledge base — with citations you can verify.',
  },
]
    ...
    <section className="py-28 px-6 relative overflow-hidden">
      ...
      <div className="relative z-10 max-w-3xl mx-auto text-center">
        ...
        <div className="flex flex-col sm:flex-row gap-4 justify-center">
          <a
            href="/sign-up"
            className="flex items-center justify-center gap-2 px-8 py-4 bg-primary-gradient text-white rounded-xl font-semibold shadow-[0_0_24px_rgba(167,165,255,0.3)] hover:shadow-[0_0_40px_rgba(167,165,255,0.5)] transition-all text-base"
          >
            Get Started Free
            <ArrowRight size={18} />
          </a>
          <a
            href="/sign-in"
            className="flex items-center justify-center gap-2 px-8 py-4 bg-surface_container_high text-white hover:bg-surface_bright border border-[#212c43] rounded-xl font-medium transition-all text-base"
          >
            Sign In
          </a>
        </div>
